...
"HonorsAwards","serviceDisabled","myPersonalities","currentLocation","location","zipCode","document","marriageCertificate",
"spouseName","service","jobTitle","servicehonorsAwards","vegetranServiceDisabled","termCondition"];
...
module.exports = {
  ...
  //     myPersonalities: Joi.number().optional().allow(""),
  ...
  //   if (_.has(payload, "Pronouns") && payload.Pronouns != "") objToSave.Pronouns = payload.Pronouns;
  ...
  //   if (_.has(payload, "HonorsAwards") && payload.HonorsAwards != "") objToSave.HonorsAwards = payload.HonorsAwards;
  //   if (_.has(payload, "serviceDisabled") && payload.serviceDisabled != "") objToSave.serviceDisabled = payload.serviceDisabled;
  //   if (_.has(payload, "myPersonalities") && payload.myPersonalities != "") objToSave.myPersonalities = payload.myPersonalities;
  //   if (_.has(payload, "currentLocation") && payload.currentLocation != "") objToSave.currentLocation = payload.currentLocation;
  //   if (_.has(payload, "location") && payload.location != "") objToSave.location = payload.location;
  //   if (_.has(payload, "zipCode") && payload.zipCode != "") objToSave.zipCode = payload.zipCode;
  //   if (_.has(payload, "document") && payload.document != "") objToSave.document = payload.document;
  //   if (_.has(payload, "marriageCertificate") && payload.marriageCertificate != "") objToSave.marriageCertificate = payload.marriageCertificate;
  //   if (_.has(payload, "spouseName") && payload.spouseName != "") objToSave.spouseName = payload.spouseName;
  //   if (_.has(payload, "service") && payload.service != "") objToSave.service = payload.service;
  //   if (_.has(payload, "jobTitle") && payload.jobTitle != "") objToSave.jobTitle = payload.jobTitle;
  //   if (_.has(payload, "servicehonorsAwards") && payload.servicehonorsAwards != "") objToSave.servicehonorsAwards = payload.servicehonorsAwards;
  //   if (_.has(payload, "vegetranServiceDisabled") && payload.vegetranServiceDisabled != "") objToSave.vegetranServiceDisabled = payload.vegetranServiceDisabled;
  //   if (_.has(payload, "termCondition") && payload.termCondition != "") objToSave.termCondition = payload.termCondition;
